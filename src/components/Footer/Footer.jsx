      ...
      <div className="container">
        ...
        <div className="flex flex-wrap justify-between gap-10">
          <div className="max-w-md">
            ...
            <div className="mt-6">
              <p className="text-gray-600 leading-relaxed text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae est, vero accusantium, quaerat temporibus iusto non placeat illum labore deserunt facere quasi. Corrupti vel assumenda voluptas sint, quae asperiores minus aut repudiandae neque tenetur dolores?</p>
            </div>
          ...
          <div className="max-lg:min-w-[140px]">
            ...
            <ul className="mt-6 space-y-4">
              ...
              <li>
                <a href="javascript:void(0)" className="hover:text-gray-800 text-gray-600 text-sm">Resources</a>
              </li>
            </ul>
          </div>
          <div className="max-lg:min-w-[140px]">
          ...
          <div className="max-lg:min-w-[140px]">
            ...
            <ul className="space-y-4 mt-6">
              ...
              <li>
                <a href="javascript:void(0)" className="hover:text-gray-800 text-gray-600 text-sm">News</a>
              </li>
            </ul>
          </div>
        </div>
